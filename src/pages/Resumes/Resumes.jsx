    ...
    <div className={style.resumes}>
      ...
      <div className={style.resumes__resume}>
        ...
        :
          !!resumes.length ?
            resumes.map(resume => (
              <Resume key={resume.id} user_id={resume.user_id} facebook={resume.facebook} dribble={resume.dribble} telegram={resume.telegram} behance={resume.behance} ai={resume.ai} vk={resume.vk} ps={resume.ps} figma={resume.figma} avgPrice={resume.price} profession={resume.profession} name={resume.name} />
            ))
            :
