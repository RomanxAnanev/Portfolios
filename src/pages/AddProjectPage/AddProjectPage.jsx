    ...
    <div className={style.addProjectPage}>
      ...
      <div className={style.addProjectPage__content}>
        ...
        <label className={style.inputs} htmlFor="">
          ...
          <input type="text" value={work.direction} onChange={(e) => setWork({...work, direction: e.target.value})} />
          <h1 className={style.input__title}>Description</h1>
          <input type="text" value={work.description} onChange={(e) => setWork({...work, description: e.target.value})} />
        </label>     
      </div>
      <label className={style.url} htmlFor="">
        <h1 className={style.input__title__url}>Url to your project</h1>
        <input className={style.input__url} type="url" value={work.url} onChange={(e) => setWork({...work, url: e.target.value})} />
