    ...
    <div className={style.editProfile}>
      ...
      <div className={style.resume}>
        ...
        <div className={style.resume__content}>
          <Resume name={name} avgPrice={avgPrice} profession={profession} vk={contacts.vk} ai={stack.ai} dribble={projects.dribble} behance={projects.behance} figma={stack.figma} ps={stack.ps} telegram={contacts.tg} facebook={contacts.fb} />
          <div className={style.content__resumText}>
            <p>The resume card is generated automatically, it remains only to enter the average cost of your service and
            ...
            <label className={style.resume__label} htmlFor="">
              <input className={style.resume__label__input} value={avgPrice} onChange={(e) => setAvgPrice(e.target.value)} type="text"/>
              <div className={style.valute}>$</div>
              <div className={style.fromTo}>From $1 to $999</div>
              <button className={style.resume__label__button} type='button' onClick={patchResume}>Add resume</button>
            </label>
          </div>
        </div>
      </div>
